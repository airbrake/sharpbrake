...
namespace Tests
{
    public class HoptoadValidator
    {
        ...
        {
            Stream schemaStream = typeof (HoptoadValidator).Assembly.GetManifestResourceStream("Tests.hoptoad_2_0.xsd");
            if (schemaStream == null) return;
            XmlSchema schema = XmlSchema.Read(schemaStream, (sender, args) => { });
...
#pragma warning restore 0618
            ...
            validator.ValidationEventHandler += (sender, args) => errorBuffer.AppendLine(args.Message);
