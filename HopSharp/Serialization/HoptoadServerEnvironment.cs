...
namespace HopSharp.Serialization
{
   ...
   /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HoptoadServerEnvironment"/> class.
        /// </summary>
        /// <param name="environmentName">Name of the environment.</param>
        public HoptoadServerEnvironment(string environmentName)
        {
        ...
        public HoptoadServerEnvironment()
        {
        }
